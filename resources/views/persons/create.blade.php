...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		{!! Form::open(['action'=>'PersonsController@create', 'class'=>'form-horizontal', 'method'=>'POST']) !!}
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="form group">
					...
					<div class="col-sm-8">
						...
						{!! Form::select('state', [] ,null, ['class'=>'form-control', 'id'=>'state', 'placeholder'=>'Select State']) !!}
					</div>
				</div>		
			</div>
			...
			<div class="col-md-4">
				<div class="form group">
					...
					<div class="col-sm-8">
						{!! Form::select('city', [] ,null, ['class'=>'form-control', 'placeholder'=>'Select City', 'id'=>"city"]) !!}
					</div>
				</div>		
			</div>
		</div>
...
<br>
	...
	<div class="row">
		...
		<button type="submit" id="submit" class="btn btn-primary pull-right"><i class="fa fa-save"></i></button>
